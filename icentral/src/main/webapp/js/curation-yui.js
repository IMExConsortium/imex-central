...
YAHOO.imex.curstat = {
    ...
    monthBtn: { my:{value:"",foo:"voulme"} },    
    monthSel: [ { text: "---ANY---", value: "" } ],

    monthFBtn: { my:{value:"--",foo:"year"} },    
    monthPtn:  { my:{value:"-",foo:"year"} },    
    monthNBtn: { my:{value:"+",foo:"year"} },    
    monthLBtn: { my:{value:"++",foo:"year"} },    
    ...
    init: function( init ){
      ...
      try{
        var CS = YAHOO.imex.curstat;
        CS.uid= init.uid;
        CS.container = init.container;

        console.log("CS.init: init=" + CS.stringify( init ));
	  ...
	  console.log("CS.init calling csTableLayoutInit");
	  CS.csTableLayoutInit( init );

      }catch( err ){
          console.error("curstat.init: "+ err);
      }    
...
*/
    ...
    csTableLayoutInit: function( init ){
        var CS = YAHOO.imex.curstat;
	var uid = CS.jid;
...
//    window, "load", YAHOO.imex.curstat({uid:<n>, container:"<div-id>"}) ) ;
